 ...
 */
@Entity
@Table(name = "veiculo_ligue")
public class VeiculoLigue implements Serializable {
	...
	public VeiculoLigue(VeiculoLigue veiculo, Usuario usuario) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VeiculoLigue other = (VeiculoLigue) obj;
		if (id == null) {
			if (other.id != null)
				return false;
