...
import br.com.seg.maxipago.datacontract.nontransactional.ApiRequest;
import br.com.seg.maxipago.datacontract.nontransactional.ApiResponse;
import br.com.seg.maxipago.datacontract.reports.RapiRequest;
import br.com.seg.maxipago.datacontract.reports.RapiResponse;
import br.com.seg.maxipago.datacontract.reports.Record;
import br.com.seg.maxipago.datacontract.reports.Records;
import br.com.seg.maxipago.datacontract.transactional.ErrorResponse;
import br.com.seg.maxipago.datacontract.transactional.Item;
import br.com.seg.maxipago.datacontract.transactional.Order;
import br.com.seg.maxipago.datacontract.transactional.Phone;
...
import br.com.seg.maxipago.datacontract.transactional.customerDocument;
...
class Utils {
	...
	private String printXml(String xml) {
    	String xmlRetorno = xml;

    	if (xml.contains("<creditCardNumber>")) {

    		int indexStart = xml.indexOf("<creditCardNumber>") + "<creditCardNumber>".length();
    		int indexEnd = xml.indexOf("</creditCardNumber>");

    		String numeroCartao = xml.substring(indexStart, indexEnd);
    		String ultimos4Digitos = numeroCartao.substring(numeroCartao.length() - 4);

    		xmlRetorno = xml.replace("<creditCardNumber>" + numeroCartao + "</creditCardNumber>",
					"<creditCardNumber>" + ultimos4Digitos + "</creditCardNumber>");
