...
public class UpdateListener extends EventListener implements PostUpdateEventListener {
    ...
    public void onPostUpdate(PostUpdateEvent postUpdateEvent) {
    	...
    	if (!postUpdateEvent.getEntity().getClass().equals(Auditoria.class)) {
    		...
    		auditoria.setClasse(postUpdateEvent.getEntity().getClass().getCanonicalName());
    		auditoria.setObjeto(converterObjectParaJson(postUpdateEvent.getEntity()));
    		auditoria.setTipoTransacao(TipoTransacaoEnum.UPDATE.getCodigo());
