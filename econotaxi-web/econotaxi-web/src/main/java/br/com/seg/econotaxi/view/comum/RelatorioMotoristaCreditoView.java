...
@Named
@Scope("view")
@ManagedBean(name = "relatorioMotoristaCreditoView")
public class RelatorioMotoristaCreditoView extends BaseView {
	...
	public void exibirRelatorio() {
		...
		if (!verificaErro) {
			...
			filtro.setFormaPagamento(FormaPagamentoEnum.CREDITO.getCodigo());
			setCorridaDataModel(new CorridaTeleDataModel(corridaService, filtro));
			setValorConsumido(corridaService.recuperarValorConsumidoMotoristaFormaPagamento(getMotorista(), 
					getMesReferencia(), FormaPagamentoEnum.CREDITO.getCodigo()));
