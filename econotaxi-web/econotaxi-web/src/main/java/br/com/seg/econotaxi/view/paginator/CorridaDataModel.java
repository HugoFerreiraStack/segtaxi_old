...
public class CorridaDataModel extends PaginatorDataModel<Corrida> {
	...
	public CorridaDataModel(CorridaService corridaService, Corrida filtro) {
	...
	protected Long obterRowCount() {
		return corridaService.pesquisarCountCorridaPorFiltro(filtro);
	}
	
	@Override
	protected List<Corrida> obterListResult(int first, int pageSize, String sortField) {
		return corridaService.pesquisarCorridaPorFiltro(filtro, first, pageSize);
	}
